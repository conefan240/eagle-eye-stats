  ...
  return (
    <header className="border-b bg-card">
      <div className="mx-auto flex max-w-3xl items-center justify-between gap-3 px-4 py-4">
        <Link
          to="/"
          className="group flex items-center gap-3 rounded-md focus:outline-none focus:ring-2 focus:ring-ring"
        >
          <img
            src={logo}
            alt="Eagle Eye Stats"
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] italic text-muted-foreground">
              "See every stroke. Track every round."
            </p>
          </div>
        </Link>
        <div className="flex items-center gap-2">{right}</div>
      </div>
      <nav className="mx-auto flex max-w-3xl gap-1 overflow-x-auto px-4 pb-2 text-xs">
